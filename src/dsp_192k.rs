...
impl LambRsSIG0 {
    ...
    pub fn fillLambRsSIG0(&mut self, count: i32, table: &mut [FaustFloat]) {
        for i1 in 0..count {
                ...
                * self.fVec1[((i32::wrapping_sub(self.IOTA0, iSlow79)) & 32767) as usize]
                + self.fRec14[0] * fTemp6
                    * self
                        ...
                        as usize] * fTemp1417;
            *io2 = fTemp5 + fTemp729 * fTemp6;
            *io3 = fTemp5 + fTemp6 * fTemp1417;
